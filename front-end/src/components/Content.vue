...
export default {
  ...
  methods: {
    ...
    update(e) {
      ...
      axios
          .post(this.server_url + "/api/upload", param, config)
          .then((response) => {
            this.percentage = 100;
            clearInterval(timer);
            this.url_1 = this.server_url + response.data.image_url;
            this.srcList.push(this.url_1);
            this.url_2 = this.server_url + response.data.draw_url;
